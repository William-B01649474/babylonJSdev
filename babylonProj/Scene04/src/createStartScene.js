import { Scene, ArcRotateCamera, Vector3, MeshBuilder, StandardMaterial, HemisphericLight, Color3, Texture, CubeTexture } from "@babylonjs/core";
...
function createSky(scene) {
    ...
    skyboxMaterial.reflectionTexture = new CubeTexture("./src/assets/textures/skybox/skybox4", scene);
